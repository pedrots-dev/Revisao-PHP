...
if ($_SERVER['REQUEST_METHOD'] === 'POST') { //Processamento de post
    ...
    if (in_array(null, $personagemCriado, true)) { //validação simples
        ...
        $personagemCriadoObj = new personagem(
            $personagemCriado['nome'],
            $personagemCriado['classe'],
            $personagemCriado['nivel'],
            $personagemCriado['vida'],
            $personagemCriado['isVivo'],
            $personagemCriado['inventario']
        );
...
if ($personagemExiste) { //se o personagem existir na sessão, exibe o status e o botão para apagar
    $personagemCriadoObj = new personagem(
        ...
        $_SESSION['personagem']['classe'],
        $_SESSION['personagem']['nivel'],
        $_SESSION['personagem']['vida'],
        $_SESSION['personagem']['isVivo'],
        $_SESSION['personagem']['inventario']
    );
    echo $personagemCriadoObj->exibirStatus();
    echo '<form method="post" action="index.php">
